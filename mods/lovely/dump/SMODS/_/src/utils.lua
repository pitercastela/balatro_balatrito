LOVELY_INTEGRITY = '575dd9b6bf9f666354a16b15f075e0c332635b0a092ed0edecbb28fb7d555a87'
...
function SMODS.score_card(card, context)
    ...
    while j <= #reps do
        if reps[j] ~= 1 then
            ...
            if eff.retrigger_flag and reps[j+1] ~= nil then SMODS.calculate_effect(eff, eff.card); j = j+1; _, eff = next(reps[j]) end
